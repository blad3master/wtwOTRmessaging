...
//blad3master: check if architecture is selected
#if !defined(__i386__) && !defined(__x86_64__)
#error "You have to select target architecture!"
#endif
...
#define BUILD_TIMESTAMP "2014-12-13T22:19+0000"
...
// blad3master: disable since it implies "asm" instruction
...
// blad3master: disable functionality (impies "asm" which is troublesome ;/)
...
//blad3master: #define HAVE_GETPAGESIZE 1

/* Define to 1 if you have the `getpid' function. */
//blad3master: #define HAVE_GETPID 1
...
// blad3master: not available at MSVC - commented out
//#define HAVE_VLA 1
