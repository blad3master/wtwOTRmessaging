...
#define WTW_CRYPTO_HASH_INIT		L"Crypto/HashInit" // wP - WTW_CRYPTO_HASH_TYPE_*, lP - void** - ctx
#define WTW_CRYPTO_HASH_UPDATE		L"Crypto/HashUpdate" // wP - void* ctx, lP - wtwDataDef*
#define WTW_CRYPTO_HASH_FINISH		L"Crypto/HashFinish" // wP - void* ctx, lP - wtwHashData* (hash and hashLen and flags are required)
...
#define WTW_CRYPTO_AES_EXPAND_KEY_EX	L"Crypto/ExpandAESKeyEx"	// returns HRESULT
...
struct wtwAESKeyInfoEx
{
	__wtwStdStructDefs(wtwAESKeyInfoEx);
	...
	void		*	expandedKeyPtr;	// expanded key
};


#define WTW_CRYPTO_AES_KEY_FLAG_ENCRYPTION 0x0001 // mutally exclusive with decryption flag
