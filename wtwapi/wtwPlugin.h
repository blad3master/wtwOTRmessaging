...
#if !defined(_DLL) && defined(_MSC_VER) && _MSC_VER == 1800
#pragma message ("You are using MSVC 12.0, please consider linking against 'Multithreaded DLL' runtime ( SP1 !!! )")
#endif
...
#define V_GET_MAJOR(a)		(DWORD)(((QWORD)a&0xFFFF000000000000ULL) >> 48) 
#define V_GET_MINOR(a)		(DWORD)(((QWORD)a&0x0000FFFF00000000ULL) >> 32)
#define V_GET_REVISION(a)	(DWORD)(((QWORD)a&0x00000000FFFF0000ULL) >> 16)
#define V_GET_BUILD(a)		(DWORD)(((QWORD)a&0x000000000000FFFFULL))
